...
public partial class MainWindowModel : CarDealerBaseWindowModel, //MainWindow works as a handler for all messages
    ...
    IRecipient<QuestionMessage>
{
    ...
    public MainWindowModel(CarDealerAppScope scope, IOptions<GeneralSettings> generalSettings)
        : base(scope)
    {
