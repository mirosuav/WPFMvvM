...
public static class VisualHelper
{
    ...
    public static readonly DependencyProperty DebugOnlyProperty = DependencyProperty.RegisterAttached(
        "DebugOnly", typeof(bool?), typeof(VisualHelper), new PropertyMetadata(default(bool?), DebugOnlyChangedCallback));

    private static void DebugOnlyChangedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
    ...
    public static void SetDebugOnly(DependencyObject element, bool? value)
    {
        element.SetValue(DebugOnlyProperty, value);
    }

    public static bool? GetDebugOnly(DependencyObject element)
    {
        return (bool?)element.GetValue(DebugOnlyProperty);
    }
